...
images=read_images("C://Users//Robogenius//Desktop//python//images")
...
while True:
    ...
    if not marker_IDs is None:
        for ids, corners in zip(marker_IDs, marker_corners):
            ...
            if ids[0]<=6:
                image_augmentation(frame, images[ids[0]],corners)
            else:
                image_augmentation(frame, images[0],corners)           
